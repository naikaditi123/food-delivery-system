...
<body>
    ...
    <div class="card">
        ...
        <p class="add"><a href="login.php">Breakfast</a></p>
        </div>
    </div> 	
    <div class="card">
        <div class="flip-card-front">
        <img src="images/3.jpg" style="width:335px;height:335px;">
        <p class="add"><a href="login.php">Lunch</a></p>
        </div>
    </div> 
    <div class="card">
        <div class="flip-card-front">
        <img src="images/4.jpg" style="width:335px;height:335px;">
        <p class="add"><a href="login.php">Snacks</a></p>
        </div>
    </div> 
    <div class="card">
        <div class="flip-card-front">
        <img src="images/2.jpg" style="width:335px;height:335px;">
        <p class="add"><a href="login.php">Dinner</a></p>
        </div>
    </div> 
    <br>
    <br>
