...
<body>
    ...
    <hr>
    <p class="cat">BREAKFAST</p>
    <hr>
    <div class="top">
    <details>
  <summary style="font-size: 25px;">INDIAN</summary>
  <br>
  <?php
  include('connection.php');

  $query = "select * from bindian";
  ...
  ?> 
   ...
   <br>
   <details>
  <summary style="font-size: 25px;">FOREIGN</summary>
  <br>
     <?php
  include('connection.php');

  $query = "select * from bforeign";
  $query_run = mysqli_query($con, $query);
  $result = mysqli_num_rows($query_run) > 0;
